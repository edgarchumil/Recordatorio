            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        <h1 class="text-center"><span class="brand-name"><b>Sistema</b></span></h1>
                        <h1 class="text-center"><span class="brand-name">Recordatorio</span></h1>
                        <h5 class="text-center"><span class="brand-name">Colua R.L.</span></h5>
...
<!--
    ...
    <img src="assets/img/colua.png" width="100%" height="100%">
        </div>
    </a>
    </div>
</div>
